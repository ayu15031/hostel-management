  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="roll_students.php" class="active">Students by Roll no.</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		  ...
		  <form method="post" class="form-inline" style="margin-top:30px; margin-left:auto; margin-right:auto;" >
				<div class="form-group">
				<label for="roll">Roll no. :</label>
				<input type="text" name="roll_no" value="<?php echo $roll;?>"class="form-control" id="roll_no">
				</div>
				<button type="submit" name="submit" class="btn btn-default">Submit</button>
		  </form>
		  <table class="table table-striped" style="margin-top:30px; display:none;" id="form">
		  <thead>
		  <tr>
		  <th>ID</th>
		  <th>NAME</th>
		...
		$roll=$_POST['roll_no'];
		$q= "select * from ".$table." where roll_no = '$roll'";
