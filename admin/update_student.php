	...
	if(isset($_POST['submit'])){
	    ...
	    if($num==0){
			$error="Incorrect roll no.";
				...
				if($num==0){
					$error="Seat for the student not booked. Add student to update seat";
				}
					...
					$old_seat=$row['seat_no'];
					$q="update ".$table1." set book_status='0' where seat_no='$old_seat' and room_no='$old_room'";
					mysqli_query($con, $q);
					$q="update ".$table." set seat_no='$seat', room_no='$room' where book_status = '1' and roll_no='$roll'" ;
					mysqli_query($con, $q);
					$q="update ".$table1." set book_status='1' where seat_no='$seat' and room_no='$room'";
					mysqli_query($con, $q);
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="update_student.php" class="active">Update Student</a></li>
                      </ul>
                  </li>
